...
namespace PrimalEditor.Editors
{
    ...
    public partial class GameEntityView : UserControl
    {
        ...
        {
            _propertyName = nameof(MSEntity.Name);
        ...
        {
            if (_propertyName == nameof(MSEntity.Name) && undoAction!= null)
            {
        ...
        {
            var undoAction1 = GetIsEnabledAction();
            var vm = DataContext as MSEntity;
            vm.IsEnabled = (sender as CheckBox).IsChecked == true;
            var redoAction1 = GetIsEnabledAction();
            Project.UndoRedo.Add(new UndoRedoAction(undoAction1, redoAction1, vm.IsEnabled==true? "Enable game entity" : "Disable game entity"));
        }
